...
namespace Administration.Infra.DataBase.EntityFramework.Migrations
{
    ...
    [Migration("20250727174636_AddSoftDelete")]
    partial class AddSoftDelete
    {
        /// <summary>
        /// Configures the target database schema for the "AddSoftDelete" migration, defining entities, owned types, relationships, and soft delete support for the Administration context.
        /// </summary>
        /// <param name="modelBuilder">The builder used to construct the entity model for the database schema.</param>
