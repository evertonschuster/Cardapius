...
namespace Administration.Infra.DataBase.EntityFramework.Migrations
{
    ...
    {
        /// <summary>
        /// Configures the entity mappings and database schema for the Administration context using Entity Framework Core.
        /// </summary>
        /// <remarks>
        /// Defines entities, owned types, relationships, table mappings, and constraints for the Administration domain, including Product, Restaurant, OutboxMessageEntity, and ProductSideDishes. Sets the default schema to "Administration" and applies PostgreSQL-specific configurations.
        /// </remarks>
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Administration.Domain.Products.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                            ...
                            b1.OwnsMany("Administration.Domain.Products.ValueObjects.SubItem", "Items", b2 =>
                                {
                                    ...
                                    b2.Property<DateTimeOffset?>("DeletedAt")
                                        .HasColumnType("timestamp with time zone");

                                    b2.Property<Guid?>("DeletedBy")
                                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ProductSideDishes", b =>
                {
                    b.HasOne("Administration.Domain.Products.Entities.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductId")
